...
class Border:
    def __init__(
        self, left=None, right=None, top=None, bottom=None, diagonal=None, diagonalUp=False, diagonalDown=False
    ):
    ...
    def __repr__(self):
        return (
            f"Border(left={self.left!r}, right={self.right!r}, top={self.top!r}, "
